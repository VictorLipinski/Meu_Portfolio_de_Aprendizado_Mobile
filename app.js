...
import ListaAlbuns from "./screens/ListaAlbuns";
import DetalhesAlbum from "./screens/DetalhesAlbum";
import ListaMusicas from "./screens/ListaMusicas";
import DetalhesMusica from "./screens/DetalhesMusica";
...
export default function App() {
    return (
        <NavigationContainer>
            <Stack.Navigator initialRouteName="ListaAlbuns">
                <Stack.Screen
                    name="ListaAlbuns"
                    component={ListaAlbum}
